...
const Footer = () => {
    return (
        <div className='max-w-screen-lg m-auto'>
            ...
            <footer className="footer lg:p-10 p-3 text-base-content">

                <div>
                    <span className="footer-title">About Us</span>
                    <p>We know there are a lot of threa<br />developers our but we pride into a<br /> firm in the industry.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <Link to='/becomeseller' className="link link-hover">Become Seller</Link>
                </div>
                <div>
            ...
            <footer className="footer items-center p-10">
                <div className="grid-flow-col gap-4 sm:place-self-center lg:justify-self-end">
