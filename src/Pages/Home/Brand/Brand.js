            ...
            <div className='max-w-screen-lg m-auto'>
                <div className='mt-12'>
                    <div className='flex justify-between '>
                        <h2 className='font-bold lg:text-3xl text-xl'>Shop by Brand</h2>
                    </div>
                    <div className='bg-white mt-5 shadow-xl rounded-md grid lg:grid-cols-6 sm:grid-cols-4 grid-cols-2'>
